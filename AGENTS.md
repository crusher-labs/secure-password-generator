# AGENTS.md - Secure Password Generator

Single-purpose static tool, built as a **world page**: combination dial. Spin a spy-proof safe dial to generate a strong password from crypto.getRandomValues; tumblers pick the character sets, bolts show the entropy, the key engraves on a brass plate. Part of the crusher-labs static tools line. Hosted on GitHub Pages at https://crusher-labs.github.io/secure-password-generator/
