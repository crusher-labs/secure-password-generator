...
Single-purpose static tool: Create strong, cryptographically random passwords with custom options. Part of the crusher-labs **static tools line** (frozen). Hosted on GitHub Pages at https://crusher-labs.github.io/secure-password-generator/
